...
function get_m1_data(){
    $.ajax({
        ...
        success:function(data){
            ...
            $(".num h1").eq(1).text(data.per_store);
            $(".num h1").eq(2).text(data.per_order);
...
function get_l1_data(){
    $.ajax({
        ...
        success:function(data){
            ...
            ec_left1_option.series[0].data = data.data_KA;
            ec_left1_option.series[1].data = data.data_GT;
...
function get_r1_data(){
    $.ajax({
        ...
        timeout:10000,
        success:function(data){
            ec_right1_option.xAxis.data = data.year;
            ec_right1_option.series[0].data = data.amount;
